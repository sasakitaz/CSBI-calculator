...
#  password.
#  Default: ''
# c.NotebookApp.password = 'Nattouya1949'
...
#  Choices: any of ['blake2s', 'sha3_256', 'sha1', 'sha3_512', 'sha224', 'sha512', 'sha3_224', 'sha3_384', 'sha384', 'blake2b', 'sha256', 'md5']
#  Default: 'sha256'
